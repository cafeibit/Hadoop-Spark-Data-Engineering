...
* In the Analyze Process stage<br>
  * Airflow has a modular architecture and uses uses a message queue to orchestrate an arbitrary number of workers, ready to scale to infinity.
